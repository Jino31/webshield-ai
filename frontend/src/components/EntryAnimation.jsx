    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center max-w-sm w-full px-6">
        ...
        <div 
          ...
          style={{ animation: 'webshieldLogoReveal 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.15s both' }}
        >
        ...
        <div 
          ...
          style={{ animation: 'webshieldTextReveal 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.65s both' }}
        >
        ...
        <p 
          ...
          style={{ animation: 'webshieldTextReveal 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.9s both' }}
        >
        ...
        <div 
          ...
          style={{ animation: 'webshieldTextReveal 0.6s cubic-bezier(0.16, 1, 0.3, 1) 1.0s both' }}
        >
          <span 
        ...
        <div 
          ...
          style={{ animation: 'webshieldTextReveal 0.6s cubic-bezier(0.16, 1, 0.3, 1) 1.1s both' }}
        >
          ...
          <div className="w-full bg-[#13111C] rounded-full h-1.5 overflow-hidden border border-[#231E33] p-[1px]">
            <div 
              ...
              style={{ animation: 'webshieldProgress 2.2s cubic-bezier(0.4, 0, 0.2, 1) 1.1s forwards', width: '0%' }}
            />
          </div>
        </div>
