    ...
    <div className={`min-h-screen flex flex-col justify-between p-4 sm:p-8 relative overflow-x-hidden transition-colors duration-300 ${
      ...
      <div className="max-w-4xl mx-auto w-full pt-6 pb-16 relative z-10">
        ...
        <div className={`backdrop-blur-xl border rounded-3xl p-6 sm:p-10 shadow-2xl mb-8 transition-all ${
          isDark ? 'bg-[#13111C]/90 border-[#231E33] shadow-purple-950/20' : 'bg-white border-slate-200 shadow-slate-200/60'
        }`}>
          <div className="flex items-center gap-3 mb-4">
            <div className={`w-12 h-12 rounded-2xl border flex items-center justify-center text-[#8B5CF6] shadow-inner ${
              isDark ? 'bg-[#1A1528] border-[#231E33]' : 'bg-purple-50 border-purple-200'
            }`}>
            ...
            <div>
              ...
              <h1 className={`text-2xl sm:text-4xl font-extrabold tracking-tight ${isDark ? 'text-[#FAFAFA]' : 'text-slate-900'}`}>
                About <span className="bg-gradient-to-r from-[#8B5CF6] to-[#EC4899] bg-clip-text text-transparent">WebShield AI</span>
              </h1>
            </div>
          </div>
          <p className={`text-sm sm:text-base leading-relaxed max-w-2xl ${isDark ? 'text-neutral-400' : 'text-slate-600'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className={`backdrop-blur-xl border p-6 rounded-3xl transition-all shadow-xl ${
            isDark ? 'bg-[#13111C]/80 border-[#231E33] hover:border-[#8B5CF6]/50' : 'bg-white border-slate-200 hover:border-purple-300 shadow-slate-200/50'
          }`}>
            ...
            <h2 className={`text-lg font-semibold mb-2 ${isDark ? 'text-[#FAFAFA]' : 'text-slate-900'}`}>Machine Learning Core</h2>
          ...
          <div className={`backdrop-blur-xl border p-6 rounded-3xl transition-all shadow-xl ${
            isDark ? 'bg-[#13111C]/80 border-[#231E33] hover:border-[#EC4899]/50' : 'bg-white border-slate-200 hover:border-pink-300 shadow-slate-200/50'
          }`}>
            <div className={`w-10 h-10 rounded-xl border flex items-center justify-center text-[#EC4899] mb-4 ${
              isDark ? 'bg-[#1A1528] border-[#231E33]' : 'bg-pink-50 border-pink-200'
            }`}>
              <Zap className="w-5 h-5" />
            </div>
            <h2 className={`text-lg font-semibold mb-2 ${isDark ? 'text-[#FAFAFA]' : 'text-slate-900'}`}>ShieldSense AI Assistant</h2>
            <p className={`text-xs sm:text-sm leading-relaxed ${isDark ? 'text-neutral-400' : 'text-slate-600'}`}>
          ...
          <div className={`backdrop-blur-xl border p-6 rounded-3xl transition-all shadow-xl ${
            isDark ? 'bg-[#13111C]/80 border-[#231E33] hover:border-[#8B5CF6]/50' : 'bg-white border-slate-200 hover:border-emerald-300 shadow-slate-200/50'
          }`}>
            <div className={`w-10 h-10 rounded-xl border flex items-center justify-center text-emerald-400 mb-4 ${
              isDark ? 'bg-[#1A1528] border-[#231E33]' : 'bg-emerald-50 border-emerald-200'
            }`}>
              <Layers className="w-5 h-5" />
            </div>
            <h2 className={`text-lg font-semibold mb-2 ${isDark ? 'text-[#FAFAFA]' : 'text-slate-900'}`}>Instant Lexical Analysis</h2>
            <p className={`text-xs sm:text-sm leading-relaxed ${isDark ? 'text-neutral-400' : 'text-slate-600'}`}>
          ...
          <div className={`backdrop-blur-xl border p-6 rounded-3xl transition-all shadow-xl ${
            isDark ? 'bg-[#13111C]/80 border-[#231E33] hover:border-[#EC4899]/50' : 'bg-white border-slate-200 hover:border-purple-300 shadow-slate-200/50'
          }`}>
            <div className={`w-10 h-10 rounded-xl border flex items-center justify-center text-[#8B5CF6] mb-4 ${
              isDark ? 'bg-[#1A1528] border-[#231E33]' : 'bg-purple-50 border-purple-200'
            }`}>
            ...
            <h2 className={`text-lg font-semibold mb-2 ${isDark ? 'text-[#FAFAFA]' : 'text-slate-900'}`}>Secure Telemetry & Logging</h2>
            <p className={`text-xs sm:text-sm leading-relaxed ${isDark ? 'text-neutral-400' : 'text-slate-600'}`}>
        ...
        <div className={`backdrop-blur-xl border rounded-3xl p-6 sm:p-8 text-left transition-all ${
          isDark ? 'bg-[#13111C]/90 border-[#231E33]' : 'bg-white border-slate-200 shadow-md'
        }`}>
          <h2 className={`text-sm font-semibold uppercase tracking-wider mb-4 ${isDark ? 'text-neutral-400' : 'text-slate-500'}`}>
          ...
          <div className="flex flex-wrap gap-2">
            {['React', 'Vite', 'Tailwind CSS', 'Node.js', 'Express', 'MongoDB', 'Python FastAPI', 'Random Forest ML', 'Google Gemini AI'].map((tech) => (
              <span key={tech} className={`px-3 py-1.5 rounded-xl border text-xs font-medium ${
                isDark ? 'bg-[#0A0A0F] border-[#231E33] text-purple-300' : 'bg-slate-100 border-slate-200 text-purple-700'
              }`}>
                {tech}
              </span>
            ))}
      ...
      <footer className={`text-center text-[11px] py-4 relative z-10 ${isDark ? 'text-neutral-500' : 'text-slate-500'}`}>
