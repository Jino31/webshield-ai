...
export const aiAssistantService = {
  async sendMessage(message, scanContext = null) {
    // Client-side guardrail against sensitive credential leaks
    ...
    try {
      ...
      return "I couldn't reach the real-time AI backend. Please ensure your Express server is running and your GEMINI_API_KEY is configured.";
    }
  }
};